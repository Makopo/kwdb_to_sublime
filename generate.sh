...
mkdir -p $OUTPUT_DIR/snippets/functions
mkdir -p $OUTPUT_DIR/snippets/constants
...
python lsl2dfg/LSL2dfg.py -u -d kwdb.xml -f sublime_completions -g sl,os -i inputs/makesnippets.pl.in | perl
